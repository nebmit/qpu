...
<aside class="plate-read">
        ...
        <div class="fade-in">
            ...
            <div>
                <div class="pr-row">
                    ...
                    <span class="pr-v"
                        >{fmt(inspectedQubit.T1, " μs", 1, 1)}</span
                    >
                </div>
                <div class="pr-row">
                    <span class="pr-l">T₂</span>
                    <span class="pr-v"
                        >{fmt(inspectedQubit.T2, " μs", 1, 1)}</span
                    >
                </div>
                <div class="pr-row">
                    <span class="pr-l">Readout error</span>
                    <span class="pr-v"
                        >{fmt(inspectedQubit.readout_error, "%", 100, 2)}</span
                    >
                </div>
                <div class="pr-row">
                    <span class="pr-l">P0|1</span>
                    <span class="pr-v"
                        >{fmt(inspectedQubit.p01, "%", 100, 2)}</span
                    >
                </div>
                <div class="pr-row">
                    <span class="pr-l">P1|0</span>
                    <span class="pr-v"
                        >{fmt(inspectedQubit.p10, "%", 100, 2)}</span
                    >
                </div>
            </div>
                ...
                {#each connEdges.slice(0, 8) as e (`${e.source}-${e.target}`)}
                    ...
                    <div class="pr-row">
                        ...
                        <span class="pr-v"
                            >{e.cx_error == null
                                ? "—"
                                : e.cx_error.toExponential(2)}</span
                        >
                    </div>
                {/each}
            {/if}
    ...
    {:else if dashboardState.clusterStats}
        ...
        <div class="cluster-result fade-in">
            ...
            {#each [{ l: "T₁", v: cs.T1 !== "—" ? `${cs.T1} μs` : "—", d: cs.deltaT1 }, { l: "T₂", v: cs.T2 !== "—" ? `${cs.T2} μs` : "—", d: cs.deltaT2 }, { l: "Readout", v: cs.ro !== "—" ? `${cs.ro}%` : "—", d: cs.deltaRo }] as row (row.l)}
                <div class="cr-row">
            ...
            <div class="cr-members">
                {#each dashboardState.cluster as id (id)}
                    <button
                        class="qchip {dashboardState.selectedId === id
                            ? 'on'
                            : ''}"
                        animate:flip={{
    ...
    <div class="read-foot">
        ...
        <div class="pr-row">
            <span class="pr-l">T₁</span>
            <span class="pr-v"
                >{dashboardState.medians.T1}{dashboardState.medians.T1 !== "—"
                    ? " μs"
                    : ""}</span
            >
        </div>
        <div class="pr-row">
            <span class="pr-l">T₂</span>
            <span class="pr-v"
                >{dashboardState.medians.T2}{dashboardState.medians.T2 !== "—"
                    ? " μs"
                    : ""}</span
            >
        </div>
        <div class="pr-row">
            ...
            <span class="pr-v"
                >{dashboardState.medians.ro}{dashboardState.medians.ro !== "—"
                    ? "%"
                    : ""}</span
            >
        </div>
